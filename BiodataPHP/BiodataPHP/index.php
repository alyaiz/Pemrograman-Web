        ...
        <div class="box-2">
          ...
          <div class="box-table">
            <table class="tabel-1">
              ...
              <tr>
                <td><b>No.HP : </b><?php echo $biodata ["nohp"] ?></td>
              </tr>
              <tr>
                <td><b>Hobi : </b><?php echo $biodata ["hobi"] ?></td>
              </tr>
              <tr>
            ...
            <table class="tabel-2">
              ...
              <tr>
                <td><b>Alamat : </b><?php echo $biodata ["alamat"] ?></td>
              </tr>
              <tr>
      ...
      <div class="container-4">
        ...
        <div class="box-sm">
          <div class="box-sosmed">
            <a
              href="mailto:alyaizzahzalfa@gmail.com"
              type="button"
            ...
            >
            <a
              href="https://instagram.com/zalfanirwana"
              type="button"
