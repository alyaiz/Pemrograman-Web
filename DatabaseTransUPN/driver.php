...
<body>
    ...
    <main role="main" class="container-fluid">
        <h2 style="margin: 60px 0 30px 0;">Data Driver</h2>
        <?php
        ...
        if (@$_GET['status'] !== NULL) {
            ...
            if ($status == 'ok') {
                echo '<div class="alert alert-success alert-dismissible fade show" role="alert" style="margin-top: 20px;">
                        <strong>Berhasil!</strong> Mengubah data driver.
                ...
                echo '<div class="alert alert-success alert-dismissible fade show" role="alert" style="margin-top: 20px;">
                        <strong>Gagal!</strong> Mengubah data driver.
                        <form method="POST" action=""><button type="submit" name="submitClose" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button></form>
                    </div>';
            }
        }
        ...
        <table class="table table-striped table-bordered">
            ...
            <tbody>
                ...
                <?php while ($data = mysqli_fetch_array($result)) : ?>
                    <tr class="text-center">
                        <td>
                            <a href="updateDriver.php?id_driver=<?php echo $data["id_driver"]; ?> " class="btn btn-warning btn-sm" style="margin-right: 5px;">Update</a>
                            <a href="deleteDriver.php?id_driver=<?php echo $data["id_driver"]; ?> " class="btn btn-danger btn-sm">Delete</a>
                        </td>
