...
$kondektur = "SELECT * FROM kondektur";
...
<body>
    ...
    <main role="main" class="container-fluid">
        <h2 style="margin: 60px 0 30px 0;">Data Kondektur</h2>
        <?php
        ...
        if (@$_GET['status'] !== NULL) {
            ...
            if ($status == 'ok') {
                echo '<div class="alert alert-success alert-dismissible fade show" role="alert" style="margin-top: 20px;">
                        <strong>Berhasil!</strong> Mengubah data kondektur.
                ...
                echo '<div class="alert alert-success alert-dismissible fade show" role="alert" style="margin-top: 20px;">
                        <strong>Gagal!</strong> Mengubah data kondektur.
                        <form method="POST" action=""><button type="submit" name="submitClose" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button></form>
                    </div>';
            }
        }
        ...
        <table class="table table-striped table-bordered">
            ...
            <tbody>
                ...
                <?php while ($data = mysqli_fetch_array($result)) : ?>
                    <tr class="text-center">
                        <td>
                            <a href="updateKondektur.php?id_kondektur=<?php echo $data["id_kondektur"]; ?> " class="btn btn-warning btn-sm" style="margin-right: 5px;">Update</a>
                            <a href="deleteKondektur.php?id_kondektur=<?php echo $data["id_kondektur"]; ?> " class="btn btn-danger btn-sm">Delete</a>
                        </td>
