        ...
        <table class="table table-striped table-bordered">
            ...
            <tbody>
                ...
                <?php while ($data = $product->fetch(PDO::FETCH_ASSOC)) : ?>
                    <tr>
                        <td class="d-flex">
                            <a href="updateProducts.php?productCode=<?php echo $data["productCode"]; ?> " class="btn btn-warning btn-sm" style="margin-right: 5px;">Update</a>
                            <a href="deleteProducts.php?productCode=<?php echo $data["productCode"]; ?> " class="btn btn-danger btn-sm">Delete</a>
                        </td>
